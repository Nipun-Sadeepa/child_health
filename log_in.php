<?php  
	...
	if(isset($_POST['submit'])){
        ...
        $_SESSION['$online_user_name']=$record['names'];
        $_SESSION['$online_user_reg_no']=$record['registration_no'];
        $_SESSION['$online_user_email']=$record['email'];
        $_SESSION['$online_user_address']=$record['addressdb'];
